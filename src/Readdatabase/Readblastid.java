...
public class Readblastid
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		String filepath="F:\\yia\\Google Drive\\SecretEPDB\\SqlFile\\Alignment\\orthologs\\";
	...
	public static void downloadFasta(String id) throws Exception
	{
		...
		File out = new File("F:\\yia\\Google Drive\\SecretEPDB\\SqlFile\\Alignment\\Aln_fasta\\" + name + ".fasta");
